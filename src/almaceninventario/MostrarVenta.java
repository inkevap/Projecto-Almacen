...
public class MostrarVenta extends javax.swing.JFrame {
    ...
    public MostrarVenta(Venta venta) {
        ...
        jLabel7.setText(jLabel7.getText()+venta.FechaCreacion);
        jLabel1.setText(jLabel1.getText()+venta.Nombre);
        jLabel8.setText(jLabel8.getText()+venta.NIT);
        jLabel9.setText(jLabel9.getText()+venta.NoVenta);
        jLabel6.setText(jLabel6.getText()+venta.total);
        for (ProductoVendido producto : venta.ProductosVendidos) {
    ...
    private void initComponents() {
        ...
        jTableVenta.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        jTableVenta.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jTableVenta.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                jTableVentaInputMethodTextChanged(evt);
            }
        });
        ...
        jLabel7.setText("Venta realizada en ");
    ...
    private void jTableVentaInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_jTableVentaInputMethodTextChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_jTableVentaInputMethodTextChanged
