 ...
 * @author Windows 10
 */
public class GestionBodega extends javax.swing.JFrame {
    //iniciado = false;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionBodega.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionBodega().setVisible(true);
            }
        });
    }
