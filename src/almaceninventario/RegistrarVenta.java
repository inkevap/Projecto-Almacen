...
public class RegistrarVenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Codigo", "Descripcion", "Estado del Producto", "Existencias", "Cantidad", "Precio por unidad", "Sub-total"
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2 && evt.getButton() == 1) {
            ...
            DefaultTableModel tabla2 = (DefaultTableModel) jTable3.getModel();//se crea una referencia a la tabla
            ...
            for (int i = 0; i < ArchivoProductos.Productos.size(); i++) {// aqui vamos comparando quien cumple con los datos de la fila seleccionada
                if (ArchivoProductos.Productos.get(i).Existencias > (Integer) tabla.getValueAt(jTable1.getSelectedRow(), 5)
                        && (Integer) tabla.getValueAt(jTable1.getSelectedRow(), 5) > 0) {//si la fecha de creacion es igual
                    if (ArchivoProductos.Productos.get(i).Existencias > 0) {//se verifica si tiene existencias antes de eliminar lo
                        Object[] row = {
                            ArchivoProductos.Productos.get(i).Nombre,
                            ArchivoProductos.Productos.get(i).Codigo,
                            ArchivoProductos.Productos.get(i).Descripcion,
                            ArchivoProductos.Productos.get(i).EstadoProducto,
                            ArchivoProductos.Productos.get(i).Existencias,
                            (Integer) tabla.getValueAt(jTable1.getSelectedRow(), 5),
                            ArchivoProductos.Productos.get(i).PrecioVenta,
                            Float.parseFloat(tabla.getValueAt(jTable1.getSelectedRow(), 5).toString()) * ArchivoProductos.Productos.get(i).PrecioVenta};
                        tabla2.addRow(row);
            ...
            for (int i = tabla2.getRowCount()-1; i >= 0; i--) {
                total += Float.parseFloat(tabla2.getValueAt(i, 7).toString());
                if (i == 0) {
    ...
    private void jTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable3MouseClicked
        if (evt.getClickCount() == 2 && evt.getButton() == 1) {
            DefaultTableModel tabla2 = (DefaultTableModel) jTable3.getModel();//se crea una referencia a la tabla
            total -= Float.parseFloat(tabla2.getValueAt(jTable3.getSelectedRow(), 7).toString());
            jLabel4.setText(String.valueOf(total));
